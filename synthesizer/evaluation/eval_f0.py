"""
Changes from: /data/haoqiuyan/github_repo/fairseq/examples/speech_synthesis/evaluation/eval_f0.py
---
Signal processing-based evaluation using waveforms
---
Usage:

python code/synthesis/evaluation/eval_f0.py  generated_data.tsv --ffe
"""
